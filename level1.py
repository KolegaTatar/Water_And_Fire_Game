import pygame
from parametry import Player, Player2, Beam, BeamG, BeamB, Lawa, g1, g2, Cash, Tep, Us
import end
pygame.init()
...
def main():
    ...
    while run:
        ...
        title = pygame.font.Font.render(pygame.font.SysFont("New Times Romana", 30), "Level: 1 ", True, (55, 245, 245))
